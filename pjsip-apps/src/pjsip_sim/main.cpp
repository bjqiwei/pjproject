...
int main(int argc, char* argv[])
{
...

    {
        ...
        public:
            ...
            void onIncomingCallReceived(int callType, const char* callid, const char* caller, const char * called)  //有呼叫呼入
            {
            ...
            void onCallReleased(const char* callid, int reason)				//呼叫挂机
            {
