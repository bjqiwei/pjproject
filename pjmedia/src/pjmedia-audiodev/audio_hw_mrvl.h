...
static char *const HW_LOOPBACK = "Hardware_Loopback";
static char *const VOICE_USER_EQ = "dha";
static char *const MICROPHONE_MODE = "microphone_mode";
static char *const VCM_CONFIG_DIRECTION = "vcm_direction";
static char *const VCM_CONFIG_TYPE = "vcm_type";
static char *const VCM_CONFIG_SRC_DST = "vcm_srcdst";
static char *const VCM_CONFIG_PRIORITY = "vcm_priority";
static char *const VCM_CONFIG_DEST = "vcm_dest";
